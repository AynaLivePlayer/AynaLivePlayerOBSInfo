...
import PlayLyric3 from "./PlayLyric3.vue";
...
<!--              class="whitespace-nowrap">-->
        <span ref="scrollSpan"
          ...
          <MediaTitle></MediaTitle> - <MediaArtist></MediaArtist> @<MediaUsername></MediaUsername>
        </span>
        <div>
          <PlayLyric3 class="text-nowrap"></PlayLyric3>
        </div>
